(function () {
    ...
    angular
        ...
        .controller('createCampaignController', ['$scope', '$location', 'mapService', 'drawService', 'projectService', 'geospatialService', 'accountService', 'authService', createProjectController]);
